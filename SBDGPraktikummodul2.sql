...
ALTER TABLE pegawai
ADD COLUMN ps_id CHAR(6) NOT NULL,
ADD CONSTRAINT fk_posisi FOREIGN KEY (ps_id) REFERENCES posisi(ps_id);
...
-- No. 5
-- Masukkan data pada tabel pelanggan
...
-- Masukkan data pada tabel mobil
...
-- Masukkan data pada tabel pegawai
...
-- Masukkan data pada tabel supplier
...
-- Masukkan data pada tabel suku_cadang
...
-- Masukkan data pada tabel tiket_servis
...
-- Masukkan data pada tabel mekanik_servis
...
-- Masukkan data pada tabel suku_cadang_servis
...
ALTER TABLE suku_cadang
ADD CONSTRAINT fk_supplier FOREIGN KEY (sc_sp_id) REFERENCES supplier(sp_id);
...
VALUES ('TS000006', CURRENT_TIMESTAMP, 'Mobil mengalami kerusakan damper belakang. Terdapat kebocoran cairan hidrolik dan kondisi damper sudah aus. Kami akan mengganti damper belakang.', '3525016005920002', '2LMTJ8JP0GSJ00175');
...
-- NO 11
UPDATE tiket_servis
SET ts_waktu_keluar = CURRENT_TIMESTAMP, ts_komentar = 'Pelayanan kurang memuaskan, goresan pada mobil tidak diperhatikan.'
